(
  ...
  (scene-2
    ...
    (music "data/musics/myst.wav")
    (hotspot 128 144 320 216
      (
        (sound "data/sounds/click.wav")
        (target "scene-7")
      )
    )
    (hotspot 0 100 448 260
      (
        (sound "data/sounds/click.wav")
        (target "scene-8")
      )
